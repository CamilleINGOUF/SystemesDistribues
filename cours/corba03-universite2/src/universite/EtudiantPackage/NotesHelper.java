...
/**
* universite/EtudiantPackage/NotesHelper.java .
* Generated by the IDL-to-Java compiler (portable), version "3.2"
* from universite.idl
* vendredi 11 mars 2016 15 h 49 CET
*/

abstract public class NotesHelper
{
  private static String  _id = "IDL:universite/Etudiant/Notes:1.0";
  ...
  synchronized public static org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      ...
      __typeCode = org.omg.CORBA.ORB.init ().create_alias_tc (universite.EtudiantPackage.NotesHelper.id (), "Notes", __typeCode);
    }
    return __typeCode;
  }
